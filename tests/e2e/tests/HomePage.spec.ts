...
uiTest(
  ...
  async ({ allure, homePage, homeAssertion }) => {
    ...
    await allure.step(
      'assert home page account balance is visible',
      async () => {
    ...
    await allure.step(
      'assert home page account balance value is $0.00',
      async () => {
...
uiTest(
  'verify user account details @UI',
  async ({ allure, homePage, homeAssertion }) => {
    await allure.suite('home page')
